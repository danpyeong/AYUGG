...
setTimeout(function () {
  ...
  for (let k = 0; k < 1; k++) {
    ...
    matchDateDiv.textContent =
      Math.floor(
        (eta.getTime() - match[k].get("matchData").gameEndTimestamp) / 3600000
      ) + "시간전";
  ...
  for (let b = 0; b < Num - 1; b++) {
    for (let a = b; a < Num - 1; a++) {
      if (
        ...
        statiexMostChamp[a + 1].get("champname")
      ) {
        statiexMostChamp[a + 1].set(
          "kills",
          statiexMostChamp[a].get("kills") +
            statiexMostChamp[a + 1].get("kills")
        );
        statiexMostChamp[a + 1].set(
          "deaths",
          statiexMostChamp[a].get("deaths") +
            statiexMostChamp[a + 1].get("deaths")
        );
        statiexMostChamp[a + 1].set(
          "assists",
          statiexMostChamp[a].get("assists") +
            statiexMostChamp[a + 1].get("assists")
        );
        statiexMostChamp[a + 1].set(
          "CS",
          statiexMostChamp[a].get("CS") + statiexMostChamp[a + 1].get("CS")
        );
        statiexMostChamp[a + 1].set(
          "win",
          statiexMostChamp[a].get("win") + statiexMostChamp[a + 1].get("win")
        );
        statiexMostChamp[a + 1].set(
          "games",
          statiexMostChamp[a].get("games") +
            statiexMostChamp[a + 1].get("games")
        );
